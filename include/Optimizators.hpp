...
namespace bpp {
    ...
    public:
       ...
       */
        ...
        static void performOptimizationNumerical(std::string optMethodModel,
                                                 unique_ptr<BackupListener> &backupListener,
                                                 unsigned int nstep,
                                                 double tolerance,
        ...
        static void performOptimizationTopology(std::string optMethodModel,
                                                std::map<std::string, std::string> &params,
                                                tshlib::TreeSearch *treesearch,
                                                bpp::AbstractHomogeneousTreeLikelihood *tl,
                                                const std::string &suffix,
        ...
        static void performOptimizationParamsAndTreeIterative(tshlib::TreeSearch *treesearch,
